    ...
    def prepare_data(self) -> None:
        ...
        for f in self._files:
            ...
            self.data[key] = pd.read_csv(
                ...
                os.path.join(self._datapath, f), compression=None
            )
...
if __name__ == "__main__":
    datapath = os.path.join("./", "mimic-iv-2.1")
